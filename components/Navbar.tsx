...
export default async function Navbar() {
    ...
    return (
        <nav className='w-full flex flex-col sm:flex-row gap-4 sm:gap-0 justify-between items-center p-4 backdrop-blur-lg bg-white/30 shadow-md mb-12 sticky top-0 z-50'>
            <Link href={`/`}>
